<template>
  <transition name="fade" mode="in-out">
    <div
      v-if="showRecipientTypeList"
      class="overlay"
      @click="$store.commit('setShowRecipientTypeList', false)"
    >
      <div class="card shadow-sm recipient-list" @click.stop>
        <div class="card-body p-2">
          ...
          <div
            ...
            "
            @click="
              $store.commit('setSelectedRecipientType', 'User')
          ...
          >
            ...
            <div class="ml-2 d-flex flex-column">
              ...
              <small
                :class="
                  'text-' +
                  (selectedRecipientType == 'User' ? 'white' : 'muted')
                "
                >Send funds to any GitHub account and oboard new users to
                Ethereum.</small
              >
            </div>
          </div>
          <div
            :class="
              'mt-2 text-left d-flex align-items-center btn btn-' +
              (selectedRecipientType == 'Issue'
                ? 'primary'
                : 'outline-light text-dark')
            "
            @click="
              $store.commit('setSelectedRecipientType', 'Issue')
              $store.commit('setShowRecipientTypeList', false)
            "
          >
            <font-awesome-icon
            ...
            <div class="ml-2 d-flex flex-column">
              ...
              <small
                :class="
                  'text-' +
                  (selectedRecipientType == 'Issue' ? 'white' : 'muted')
                "
