...
const octoBay = require('./.evm/build/contracts/OctoBay.json')
const octoPin = require('./.evm/build/contracts/OctoPin.json')
const link = require('./.evm/build/contracts/LinkToken.json')
